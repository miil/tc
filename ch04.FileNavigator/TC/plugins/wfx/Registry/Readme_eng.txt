Registry v 4.8 - plugin for Total Commander 5.51 and newer.
...
v 4.8 - 26.09.2009
  ...
  - Added: Better keyboard support in search window (Enter, Context and Shift+F10)
  ...
  - Changed: Multiselection in search result window (press Shift+Copy to copy one cell only)
  - Changed: Search can be cancelled much quicker, UI is more responsive


I have been developing this plugin since November 2002, 
constantly improving it and adding new features requested by the users. 
Despite the amount of work the plugin is (and will remain) free for any use. 
However, if you find this program useful, I will appreciate any donation, 
which would support the future development: 
http://www.knyazeff.com/Donate.html
