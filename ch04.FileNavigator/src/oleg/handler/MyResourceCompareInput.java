 ...
 */
public class MyResourceCompareInput extends CompareEditorInput {
	 ...
	 */
	MyResourceCompareInput(CompareConfiguration config) {
		super(config);
	}
	...
	private boolean showCompareWithOtherResourceDialog(Shell shell, ISelection s) {
		MyCompareWithOtherResourceDialog dialog = new MyCompareWithOtherResourceDialog(shell, s);
